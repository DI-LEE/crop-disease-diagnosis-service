...
from . import encoder_decoder_model_DI as ic
...
def create_masks_decoder(tar):
    look_ahead_mask = ic.create_look_ahead_mask(tf.shape(tar)[1])
    dec_target_padding_mask = ic.create_padding_mask(tar)
...
def generate_captions(image):  # 실제 예측 함수
    ...
    captions = load_label_start_end(
               '/home/ubuntu/projects/crop-disease-diagnosis-service/app_back/image_captioning/label/crop_life_final.csv')
    ...
    transformer = ic.define_transformer_weights()
