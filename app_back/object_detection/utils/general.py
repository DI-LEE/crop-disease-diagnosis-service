...
from app_back.object_detection.utils.downloads import gsutil_getsize
from app_back.object_detection.utils.metrics import box_iou, fitness
...
def check_amp(model):
    ...
    from app_back.object_detection.models.common import AutoShape, DetectMultiBackend
