...
from app_back.object_detection.utils.general import LOGGER, check_version, colorstr, file_date, git_describe
...
def reshape_classifier_output(model, n=1000):
    ...
    from app_back.object_detection.models.common import Classify
