...
from app_back.utils.downloads import gsutil_getsize
from app_back.utils.metrics import box_iou, fitness
...
def check_amp(model):
    ...
    from app_back.models.common import AutoShape, DetectMultiBackend
